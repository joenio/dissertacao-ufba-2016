...
Neste estudo iremos fazer um levantamento de softwares científicos e softwares
...
A forma como o levantamento será feito está descrito na seção
\ref{levantamento}, a partir daí será feito uma caracterização inicial da
ferramenta e posteriormente análise estática do seu código-fonte.  Esta
análise irá nos dizer se temos valores de referência de métricas para
ferramentas de análise estática de código-fonte, com isto iremos criar
recomendações de refatoração para ferramentas de análise estática.

Por final traçaremos um paralelo entre as caracteristicas de qualidade externa
aos valores de métricas encontrados (qualidade interna). Especialmente em
...
para a seleção de métricas foram aquelas que medem aspectos relevantes à
manutenibilidade do software.

Nós iremos neste estudo utilizar a mesma seleção de métricas utilizadas por
\citeonline{Meirelles2013}, abaixo, a fim de caracterizar a qualidade interna dos
softwares científicos estudados neste trabalho de pesquisa.
...
%Outro critério utilizado na escolha das métricas que detalharemos
