...
Com base no trabalho realizado por \citeonline{Meirelles2013} onde associou-se
qualidade de software à qualidade de código através de métricas de
código-fonte como indicador para o sucesso de projetos de software livre,
foram utilizadas as métricas abaixo neste estudo, e utilizaremos aqui as
mesmas:
