...
%Estes softwares científicos são artefatos de pesquisa e como produtos de
%software precisam ser avaliados com uso de métodos científicos
%adequados, e, é de fundamental importância que estejam disponíveis e em
%funcionamento \cite{Kon2011}. A disponibilidade destes softwares é peça
%fundamental para possibilitar a reprodutibilidade dos estudos relacionados,
%proporcionando assim, meios para validar tais pesquisas.
...
%Estes softwares científicos precisam estar disponíveis e em funcionamento
%\cite{Kon2011} pois são peça 
...
quais é preciso esclarecer, \citeonline{Feitelson2015} propõe o seguinte:

%Este conceito é um ponto central do método
%científico e continua a receber bastante atenção como pode ser verificado em
%estudos recentes \cite{Stodden2009} \cite{Vitek2011} \cite{Stodden2012}
%\cite{Krishnamurthi2015} \cite{Stodden2015} \cite{GithubReproducibilityGuide}.
...
%os pesquisadores diante disto e preocupado em criar uma linguagem comum entre
...
\citeonline{Peng2011} em seu espectro de reprodutibilidade reproduzido aqui
na Figura \ref{reproducibility-spectrum}.

%) a disponibilidade do código é o requisito mínimo.
%Este é um problema sério já que um dos fundamentos
...
%\cite{WikiBooksSoftwareEngineering} \cite{Staines2015} 
...
%\citeonline{WikiBooksSoftwareEngineering} enumera algumas questões à respeito
