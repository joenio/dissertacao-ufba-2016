...
* P. Andersson and K. Kuchcinski. **Java to hardware compilation for non data flow applications**. 2005.
...
* Q. Yi and K. Seymour and H. You and R. Vuduc and D. Quinlan. **POET: Parameterized Optimizations for Empirical Tuning**. 2007.
...
* T. Zhang and Y. q. Cui. **A Bilateral Control of Teleoperators Based on Time Delay Identification**. 2008.
...
* Lajos Hanzo and Clare Somerville and Jason Woodard. **The Voice over Internet Protocol**. 2007.
...
* Q. Wu and G. Liang and Q. Wang and T. Xie and H. Mei. **Iterative mining of resource-releasing specifications**. 2011.
...
* E. Aftandilian and R. Sauciuc and S. Priya and S. Krishnan. **Building Useful Program Analysis Tools Using an Extensible Java Compiler**. 2012.
...
* F. Thung and D. Lo and J. Lawall. **Automated library recommendation**. 2013.
...
* X. Luo and L. Xue and C. Shi and Y. Shao and C. Qian and E. W. W. Chan. **On Measuring One-Way Path Metrics from a Web Server**. 2014.
...
* J. Kim and D. Batory and D. Dig. **Scripting parametric refactorings in Java to retrofit design patterns**. 2015.
...
* M. Alamir and M. Fiacchini and S. B. Chabane and S. Bacha and T. Kovaltchouk. **Active power control under Grid Code constraints for a tidal farm**. 2016.
...
* Q. Stiévenart and M. Vandercammen and W. D. Meuter and C. D. Roover. **Scala-AM: A Modular Static Analysis Framework**. 2016.
...
* E. F. Rizzi and S. Elbaum and M. B. Dwyer. **On the Techniques We Create, the Tools We Build, and Their Misalignments: A Study of KLEE**. 2016.
...
* Altidor, John and Smaragdakis, Yannis. **Refactoring Java Generics by Inferring Wildcards, in Practice**. 2014.
...
* Budimlic, Zoran and Kennedy, Ken. **Almost-whole-program Compilation**. 2002.
...
* Distefano, Dino and Parkinson J, Matthew J.. **jStar: Towards Practical Verification for Java**. 2008.
...
* Gvero, Tihomir and Kuncak, Viktor. **Synthesizing Java Expressions from Free-form Queries**. 2015.
...
* L\'{o}pez, Hugo A. and Marques, Eduardo R. B. and Martins, Francisco and Ng, Nicholas and Santos, C{\'e}sar and Vasconcelos, Vasco Thudichum and Yoshida, Nobuko. **Protocol-based Verification of Message-passing Parallel Programs**. 2015.
...
* Nhu, Duong and Chua, Caslon. **Preprocessing Code Example For Searching**. 2015.
...
* Robby and Chalin, Patrice. **Preliminary Design of a Unified JML Representation and Software Infrastructure**. 2009.
...
* Shenoy, Sreekumar T. and Ozsoyoglu, Z. Meral. **A System for Semantic Query Optimization**. 1987.
* Siavashi, Faezeh and Truscan, Dragos. **Environment Modeling in Model-based Testing: Concepts, Prospects and Research Challenges: A Systematic Literature Review**. 2015.
* Siegel, Stephen F.. **CIVL Solutions to Verifythis 2016 Challenges**. 2017.
* Snow, Stephen and Vyas, Dhaval. **Fixing the Alignment: An Exploration of Budgeting Practices in the Home**. 2015.
* Snow, Stephen and Vyas, Dhaval. **Fostering Collaboration in the Management of Family Finances**. 2015.
* Soetens, Quinten David and Robbes, Romain and Demeyer, Serge. **Changes As First-Class Citizens: A Research Perspective on Modern Software Tooling**. 2017.
* Sohan, S M and Anslow, Craig and Maurer, Frank. **Automated Example Oriented REST API Documentation at Cisco**. 2017.
* Song, Fu and Touili, Tayssir. **PoMMaDe: Pushdown Model-checking for Malware Detection**. 2013.
* Song, Linhai and Lu, Shan. **Statistical Debugging for Real-world Performance Problems**. 2014.
* Song, Linhai and Lu, Shan. **Performance Diagnosis for Inefficient Loops**. 2017.
* Spasojevi\'{c}, Boris and Ghafari, Mohammad and Nierstrasz, Oscar. **The Object Repository: Pulling Objects out of the Ecosystem**. 2016.
* Spring, Jesper H. and Privat, Jean and Guerraoui, Rachid and Vitek, Jan. **Streamflex: High-throughput Stream Programming in Java**. 2007.
* Squicciarini, Anna C. and Shehab, Mohamed and Wede, Joshua. **Privacy Policies for Shared Content in Social Network Sites**. 2010.
* Sridharan, Manu and Artzi, Shay and Pistoia, Marco and Guarnieri, Salvatore and Tripp, Omer and Berg, Ryan. **F4F: Taint Analysis of Framework-based Web Applications**. 2011.
* Steimann, Friedrich and Hagemann, J\"{o}rg and Ulke, Bastian. **Computing Repair Alternatives for Malformed Programs Using Constraint Attribute Grammars**. 2016.
* Steindorfer, Michael J. and Vinju, Jurgen J.. **Optimizing Hash-array Mapped Tries for Fast and Lean Immutable JVM Collections**. 2015.
* Stewart, Christopher and Kelly, Terence and Zhang, Alex. **Exploiting Nonstationarity for Performance Prediction**. 2007.
* Stilkerich, Isabella and Strotz, Michael and Erhardt, Christoph and Hoffmann, Martin and Lohmann, Daniel and Scheler, Fabian and Schr\"{o}der-Preikschat, Wolfgang. **A JVM for Soft-error-prone Embedded Systems**. 2013.
* Stilkerich, Isabella and Taffner, Philip and Erhardt, Christoph and Dietrich, Christian and Wawersich, Christian and Stilkerich, Michael. **Team Up: Cooperative Memory Management in Embedded Systems**. 2014.
* Stilkerich, Isabella and Lang, Clemens and Erhardt, Christoph and Stilkerich, Michael. **A Practical Getaway: Applications of Escape Analysis in Embedded Real-Time Systems**. 2015.
* Stilkerich, Isabella and Lang, Clemens and Erhardt, Christoph and Bay, Christian and Stilkerich, Michael. **The Perfect Getaway: Using Escape Analysis in Embedded Real-Time Systems**. 2017.
* Sultana, Nik and Thompson, Simon. **Mechanical Verification of Refactorings**. 2008.
* Tan, Shin Hwei and Yi, Jooyong and Yulis and Mechtaev, Sergey and Roychoudhury, Abhik. **Codeflaws: A Programming Competition Benchmark for Evaluating Automated Program Repair Tools**. 2017.
* Tang, Xiaolong and J\"{a}rvi, Jaakko. **Generic Flow-sensitive Optimizing Transformations in C++ with Concepts**. 2010.
* Tang, Xiaolong and J\"{a}rvi, Jaakko. **Exploiting Regularity of User-defined Types to Improve Precision of Program Analyses**. 2012.
* Tang, Xiaolong and J\"{a}rvi, Jaakko. **Summary-based Data-flow Analysis That Understands Regular Composite Objects and Iterators**. 2012.
* Tanik, Murat M.. **A Comparison of Program Complexity Prediction Models**. 1980.
* Taylor, Ramsay and Derrick, John. **Smother: An MC/DC Analysis Tool for Erlang**. 2015.
* Thomson, Paul and Donaldson, Alastair F. and Betts, Adam. **Concurrency Testing Using Schedule Bounding: An Empirical Study**. 2014.
* Thomson, Paul and Donaldson, Alastair F. and Betts, Adam. **Concurrency Testing Using Controlled Schedulers: An Empirical Study**. 2016.
* Thummalapenta, Suresh and Xie, Tao. **Parseweb: A Programmer Assistant for Reusing Open Source Code on the Web**. 2007.
* Thummalapenta, Suresh and Xie, Tao and Tillmann, Nikolai and de Halleux, Jonathan and Su, Zhendong. **Synthesizing Method Sequences for High-coverage Testing**. 2011.
* Tidwell, Terry and Gill, Christopher. **Towards Verifiable Deeply Embedded Systems**. 2008.
* Titzer, Ben L. and Palsberg, Jens. **Vertical Object Layout and Compression for Fixed Heaps**. 2007.
* Tkachuk, Oksana and Rajan, Sreeranga P.. **Application of Automated Environment Generation to Commercial Software**. 2006.
* Tkachuk, Oksana and Rajan, Sreeranga P.. **Combining Environment Generation and Slicing for Modular Software Model Checking**. 2007.
* Tokuyama, Takeshi and Nakano, Jun. **Efficient Algorithms for the Hitchcock Transportation Problem**. 1992.
* (??). **FSE '12: Proceedings of the ACM SIGSOFT 20th International Symposium on the Foundations of Software Engineering**. 2012.
* Twaroch, Florian A. and Jones, Christopher B. and Abdelmoty, Alia I.. **Acquisition of a Vernacular Gazetteer from Web Sources**. 2008.
* Ubayashi, Naoyasu and Sakai, Akihiro and Tamai, Tetsuo. **An Aspect-oriented Weaving Mechanism Based on Component and Connector Architecture**. 2007.
* Ubayashi, Naoyasu and Sakai, Akihiro and Tamai, Tetsuo. **An Interface Mechanism for Encapsulating Weaving in Class-based AOP**. 2007.
* Ubayashi, Naoyasu and Akatoki, Hidenori and Nomura, Jun. **Pointcut-based Architectural Interface for Bridging a Gap Between Design and Implementation**. 2009.
* Ullah, Faheem and Gross, Thomas R.. **Profiling for Detecting Performance Anomalies in Concurrent Software**. 2015.
* Urban, Matthias and Lohmann, Daniel and Spinczyk, Olaf. **The Aspect-oriented Design of the PUMA C/C++ Parser Framework**. 2010.
* Vakilian, Mohsen and Negara, Stas and Tasharofi, Samira and Johnson, Ralph E.. **Keshmesh: A Tool for Detecting and Fixing Java Concurrency Bug Patterns**. 2011.
* Van Nguyen, Thanh and Nguyen, Anh Tuan and Phan, Hung Dang and Nguyen, Trong Duc and Nguyen, Tien N.. **Combining Word2Vec with Revised Vector Space Model for Better Code Retrieval**. 2017.
* Van Nieuwpoort, Rob V. and Wrzesi\'{n}ska, Gosia and Jacobs, Ceriel J. H. and Bal, Henri E.. **Satin: A High-level and Efficient Grid Programming Model**. 2010.
* Vasilescu, Bogdan and Casalnuovo, Casey and Devanbu, Premkumar. **Recovering Clear, Natural Identifiers from Obfuscated JS Names**. 2017.
* Visser, Willem and P\v{a}s\v{a}reanu, Corina S. and Khurshid, Sarfraz. **Test Input Generation with Java PathFinder**. 2004.
* Visser, Eelco and Wachsmuth, Guido and Tolmach, Andrew and Neron, Pierre and Vergu, Vlad and Passalaqua, Augusto and Konat, Gabrie\"{e}l. **A Language Designer's Workbench: A One-Stop-Shop for Implementation and Verification of Language Designs**. 2014.
* Vojdani, Vesal and Apinis, Kalmer and R\~{o}tov, Vootele and Seidl, Helmut and Vene, Varmo and Vogler, Ralf. **Static Race Detection for Device Drivers: The Goblint Approach**. 2016.
* Volanschi, Nic. **Condate: A Proto-language at the Confluence Between Checking and Compiling**. 2006.
* Volanschi, Nic and Rinderknecht, Christian. **Unparsed Patterns: Easy User-extensibility of Program Manipulation Tools**. 2008.
* Vyas, Dhaval and Snow, Stephen and Roe, Paul and Brereton, Margot. **Social Organization of Household Finance: Understanding Artful Financial Systems in the Home**. 2016.
* Walkinshaw, Neil and Bogdanov, Kirill. **Automated Comparison of State-Based Software Models in Terms of Their Language and Structure**. 2013.
* Wang, Weihang and Zheng, Yunhui and Liu, Peng and Xu, Lei and Zhang, Xiangyu and Eugster, Patrick. **ARROW: Automated Repair of Races on Client-side Web Pages**. 2016.
* Watson, Robert N. M.. **A Decade of OS Access-control Extensibility**. 2013.
* Weimer, Westley and Necula, George C.. **Exceptional Situations and Program Reliability**. 2008.
* Weitz, Konstantin and Kim, Gene and Srisakaokul, Siwakorn and Ernst, Michael D.. **A Type System for Format Strings**. 2014.
* White, Brian S. and McKee, Sally A. and Quinlan, Daniel. **A Projection-based Optimization Framework for Abstractions with Application to the Unstructured Mesh Domain**. 2008.
* White, David H. and Rupprecht, Thomas and L\"{u}ttgen, Gerald. **DSI: An Evidence-based Approach to Identify Dynamic Data Structures in C Programs**. 2016.
* Wightman, Doug and Ye, Zi and Brandt, Joel and Vertegaal, Roel. **SnipMatch: Using Source Code Context to Enhance Snippet Retrieval and Parameterization**. 2012.
* Wilcox, Thomas R.. **Aspen Language Specifications**. 1977.
* Wilkerson, Josh L. and Tauritz, Daniel R. and Bridges, James M.. **Multi-objective Coevolutionary Automated Software Correction**. 2012.
* Willcock, Jeremiah James and Lumsdaine, Andrew and Quinlan, Daniel J.. **Reusable, Generic Program Analyses and Transformations**. 2009.
* Wimmer, Christian and M\"{o}ssenb\"{o}sck, Hanspeter. **Automatic Feedback-directed Object Fusing**. 2010.
* Wimmer, Christian and Haupt, Michael and Van De Vanter, Michael L. and Jordan, Mick and Dayn\`{e}s, Laurent and Simon, Douglas. **Maxine: An Approachable Virtual Machine for, and in, Java**. 2013.
* Wimpey, Bradley J. and Potter, Walter D.. **Reusing Objects for Realistic 3D Maps**. 2008.
* Winther, Johnni. **Improving Precision of Generated ASTs**. 2012.
* Wires, Jake and Ingram, Stephen and Drudi, Zachary and Harvey, Nicholas J. A. and Warfield, Andrew. **Characterizing Storage Workloads with Counter Stacks**. 2014.
* Witkowski, Thomas and Blanc, Nicolas and Kroening, Daniel and Weissenbacher, Georg. **Model Checking Concurrent Linux Device Drivers**. 2007.
* Worm, Tony and Chiu, Kenneth. **Prioritized Grammar Enumeration: Symbolic Regression by Dynamic Programming**. 2013.
* Wu, Hui and Gray, Jeff and Roychoudhury, Suman and Mernik, Marjan. **Weaving a Debugging Aspect into Domain-specific Language Grammars**. 2005.
* Wu, Xiaoqing and Bryant, Barrett R. and Gray, Jeff and Roychoudhury, Suman and Mernik, Marjan. **Separation of Concerns in Compiler Development Using Aspect-orientation**. 2006.
* Xiaofei, Xie. **Static Loop Analysis and Its Applications**. 2016.
* Xie, Xiaofei and Chen, Bihuan and Liu, Yang and Le, Wei and Li, Xiaohong. **Proteus: Computing Disjunctive Loop Summary via Path Dependency Analysis**. 2016.
* Yang, Zijiang and Wang, Chao and Gupta, Aarti and Ivan\v{c}i\'{c}, Franjo. **Model Checking Sequential Software Programs via Mixed Symbolic Analysis**. 2009.
* Yessenov, Kuat and Xu, Zhilei and Solar-Lezama, Armando. **Data-driven Synthesis for Object-oriented Frameworks**. 2011.
* Yi, Qing and Whaley, R. Clint. **Automated Transformation for Performance-critical Kernels**. 2007.
* Yi, Jooyong and Ahmed, Umair Z. and Karkare, Amey and Tan, Shin Hwei and Roychoudhury, Abhik. **A Feasibility Study of Using Automated Program Repair for Introductory Programming Assignments**. 2017.
* Yu, Fang and Bultan, Tevfik and Peterson, Erik. **Automated Size Analysis for OCL**. 2007.
* Yu, Junfeng and Zhang, Shengzhi and Liu, Peng and Li, ZhiTang. **LeakProber: A Framework for Profiling Sensitive Data Leakage Paths**. 2011.
* Yu, Fang and Yang, Shun-Ching and Wang, Farn and Chen, Guan-Cheng and Chan, Che-Chang. **Symbolic Consistency Checking of OpenMp Parallel Programs**. 2012.
* Yu, Haibo and Song, Wenhao and Mine, Tsunenori. **APIBook: An Effective Approach for Finding APIs**. 2016.
* Zaeem, Razieh Nokhbeh and Khurshid, Sarfraz. **Contract-based Data Structure Repair Using Alloy**. 2010.
* Zanjani, Motahareh Bahrami and Swartzendruber, George and Kagdi, Huzefa. **Impact Analysis of Change Requests on Source Code Based on Interaction and Commit Histories**. 2014.
* Zhang, Dezhuang and Cleaveland, Rance. **Efficient Temporal-logic Query Checking for Presburger Systems**. 2005.
* Zhang, Wei and Lim, Junghee and Olichandran, Ramya and Scherpelz, Joel and Jin, Guoliang and Lu, Shan and Reps, Thomas. **ConSeq: Detecting Concurrency Bugs Through Sequential Errors**. 2011.
* Zhang, Cheng and Yang, Juyuan and Zhang, Yi and Fan, Jing and Zhang, Xin and Zhao, Jianjun and Ou, Peizhao. **Automatic Parameter Recommendation for Practical API Usage**. 2012.
* Zhang, Sai and L\"{u}, Hao and Ernst, Michael D.. **Finding Errors in Multithreaded GUI Applications**. 2012.
* Zhang, Sai and L\"{u}, Hao and Ernst, Michael D.. **Automatically Repairing Broken Workflows for Evolving GUI Applications**. 2013.
* Zhang, Hongyu and Jain, Anuj and Khandelwal, Gaurav and Kaushik, Chandrashekhar and Ge, Scott and Hu, Wenxiang. **Bing Developer Assistant: Improving Developer Productivity by Recommending Sample Code**. 2016.
* Zhong, Hua and Zhang, Lingming and Khurshid, Sarfraz. **Combinatorial Generation of Structurally Complex Test Inputs for Commercial Software Applications**. 2016.
* Zhu, Zixiao and Zou, Yanzhen and Jin, Yong and Xie, Bing. **Generating API-usage Example for Project Developers**. 2013.
* Zijiang Yang and Chao Wang and Gupta, A. and Ivancic, F.. **Mixed Symbolic Representations for Model Checking Software Programs**. 2006.
* claffy, kc. **The 3rd Workshop on Active Internet Measurements (AIMS-3) Report**. 2011.
* claffy, kc. **The 4th Workshop on Active Internet Measurements (AIMS-4) Report**. 2012.
* de Jonge, Maartje and Visser, Eelco. **A Language Generic Solution for Name Binding Preservation in Refactorings**. 2012.
