...
A discussão é guiada pelas questões de pesquisa apresentadas no
Capítulo \ref{introducao}.
A pesquisa  adotou uma estratégia de estudo de campo em ambiente natural, 
com alto realismo no contexto estudado e, 
consequentemente, com baixa generalização e,
portanto, seus resultados e conclusões são específicos ao domínio de análise
estática.
