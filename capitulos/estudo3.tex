...
Este estudo foi organizado em duas fases, primeiro uma análise dos dados
existentes para cada software, dados coletados nos Capítulos \ref{estudo1} e
\ref{estudo2}, com objetivo de definir quais projetos terão mais coleta de
dados, para num segundo momento caracterizá-los em relação ao estágio de
evolução.

Nesta primeira fase, coletamos para os projetos com disponibilidade de
download, ou ao menos, entre aqueles com alguma presença oficial online com
informações do projeto, quando disponível, informações sobre os lançamentos,
incluindo para cada lançamento:
...
A coleta desses dados é realizada manualmente através das informações
disponíveis no site dos projetos, manuais, código fonte e repositórios, podendo
compor com informações de diversas fontes para ter uma maior abrangencia de
informações, não é raro que os projetos mudem a forma de lançamentos, passando
de um formato para outro, de uma plataforma a outra, essas informações devem
ser investigadas a fim de encontrar o máximo de informação possível sobre os
lançamentos.
...
Aqueles projetos sem disponibilidade de download, ou seja, os projetos
indisponíveis e sem presença oficial online serão automaticamente
caracterizados como projetos com ciclo de vida encerrados a partir do modelo
{\it ``Staged Model for Software Evolution''}, estes projetos serão
caracterizados como estando na fase {\it ``Closedown''}.

Entre os projetos com disponibilidade de código fonte, e com código fonte
disponível para cada lançamento, foi feito o download do código fonte para
coleta do número de módulos através de análise estática com a ferramenta
Analizo. Apenas os projetos escritos em linguagens suportadas pelo Analizo -- C,
C++ e Java -- foram analizados.
...
varias versoes de alguns projetos), a analise individual. Projetos com poucos releases,
digamos, abaixo de 5, não serão analisados em detalhes na avaliação histórica, mas
terão os dados das métricas analisados para definir o estágio de evolução.
