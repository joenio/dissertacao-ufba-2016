...
O objeto de estudo é a sustentabilidade técnica de projetos de software acadêmico de análise estática.

\item{\bf Propósito.} 
O propósito deste estudo é caracterizar ...

\item{\bf Perspectiva.} 
A perspectiva considerada é a do pesquisador, isto é, 
o pesquisador gostaria de saber se software acadêmico de análise estática tem
uma comunidade ... é mencionado ... Além disso, ...

\item{\bf Foco.} 
O principal aspecto de qualidade estudado é a sustentabilidade técnica,
sendo NNN aspectos enfatizados: A, B, C ... EXPLICAR A, B, C.
...
Analisar a \textit{sustentabilidade técnica de projetos de software acadêmico de análise estática} % object of study
...
na perspectiva do \textit{pesquisador} % perspective
...
Quando a leitura do título, introdução, resultados e conclusão não é suficiente
...
Todas as trilhas de ambas as conferências foram incluídas, 1527 artigos da
conferência ASE e 346 artigos da conferência SCAM, até o ano de 1996 a
conferencia ASE chamava-se KBSE\footnote{ Knowledge-Based Software Engineering
Conference} e só a partir de 1997 mudou para ASE, a conferência SCAM teve sua
primeira edição apenas em 2001, 10 anos após a primeira edição do ASE.
