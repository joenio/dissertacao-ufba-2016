...
Pesquisas reproduzíveis ({\it RR - Reproducible Research}) não resolve todos os
problemas de validade experimental dos estudos em engenharia de software, mas
garante que dados e métodos de análise estejam disponíveis para inspeção e que
os resultados possam ser derivados, facilitando a revisão logo que a
publicação acontece. Além de ser é um recurso valoroso para pesquisadores
iniciantes. Outra vantagem é que RR melhoram o impacto do estudo, por exemplo,
artigos de computação que não disponibilizam pubicamente dados e códigos
possuem menos chance de serem citados \cite{madeyski2017would}.
...
Além da preocupação com reprodutibilidade ou repetição, inúmeras iniciativas e
manifestos tem enfatizado a necessidade de aumentar a preocupação em relação aos
softwares desenvolvidos, alguns afirmando que todo software deve vir a se tornar
cidação de primeira classe, assim como acontece com as próprias publicações, ou seja,
citação de software, publicação de software, referências, etc \cite{allen2017engineering}.
...
\begin{itemize}
  ...
  \item Karlskrona Manifesto for Sustainability Design \cite{becker2014karlskrona}\footnote{\url{http://sustainabilitydesign.org}}

    Inclui uma definição abrangente de sustentabilidade, incluindo sustentabilidade de software.
...
Trazer para cá notas do artigo \cite{venters2014software} que faz uma revisao do termo sustentabilidade na área.

E concentrar nas definições do Karlskrona manifesto, irei usar as definicoes dele aqui, abaixo:

Como praticantes e pesquisadores de software, nós somos parte do grupo de
pessoas que projetam sistemas de software que rodam no mundo. Nosso trabalho
nos faz cada vez mais conscientes do impacto que destes sistemas e da responsabilidade
que vem com seu papel, até o momento em que tecnologia da informação e comunicação são
moldando o futuro. Nós lutamos para reconciliar nossa preocupação com o planeja Terra
e com a sociedade com o trabalho que fazemos. Através deste trabalho nós começamos
a antender que precisamos redefinir a narrativa sobre sustentabilidade e o papel que isto
tem em nossa profissão.

O que sustentabilidade, realmente? Nós frequentemente definimos isto muito
estreitamente. Sustentabilidade é o coração de um conceito sistêmico e precisa
ser entendido em uma séria de dimensões, incluindo social, individual,
ambiental, economico e técnico.

Quais são essas dimensões, realmente?

\begin{description}
  \item [Sustentabilidade individual]
    refere-se a manter o capital humano (exemplo: saúde, educação, habilidades,
    conhecimento, liderança, e acesso a serviços).
  \item [Sustentabilidade social]
    objetiva preservar as comunidades societárias e sua solidariedade e
    serviços.
  ...
  \item [Sustentabilidade técnica]
    ...
    adequada evolução com as condições do ambiente sempre em mudança.
\end{description}

Sustentabilidade é fundamental em nossa sociedade. O estado atual do nosso
mundo é insustentável em mais de uma forma que nós frequentemente reconhecemos.
Tecnologia é parte deste dilema e parte das possíveis respostas.  Nós
frequentemente falamos sobre o impacto imediato da tecnologia, mas raramente
conhecemos seus efeitos indiretos e sistêmicos.  Esses efeitos influem sobre
todas as dimenções da sustentabilidade no curto, médio e longo prazo.

Software em particular ocupa um papel central na sustentabilidade. Isto pode
nos levar a uma crescente consumo de recursos, crescimento desigualdade na
sociedade, e falta de auto-estima individual. Mas isto pode também criar
comunidades e habilitar crescimento da liberdade individual, processos
democráticos, e recursos de conservação.  Como designers de tecnologia de
software, nós somos responsáveis pelas consequencias de longa duração dos
nossos designs. Design é o processo de entender o mundo e articular uma
alternativa conception de como itso pode ser formado, deacordo com as intenções
dos designers. Através do design, nós causamos mudança e configuramos nosso
ambiente. Se nos não tomamos sustentabilidade em consideração ao designing,
não importa em qual domínio e qual propósito, nós perdemos a oportunidade
de causar mudanas positivas.

...

Como resultado, mesmo apesar da importancia da sustentabilidade é crescentemente
reconhecidas, muitos sistemas de siftware são insustentáveis, e os amplos impactos
da maioria dos sistemas de software em sustentabilidade são desconhecidos.

Portanto, nós propomos os seguintes conjuntos inicial de princípios e
compromissos:

\begin{description}

  \item [Sustentabilidade é sistêmica]
    Sustentabilidade nunca é uma propriedade isolada. Systems thinking deve ser o
    ponto para a transdiciplinaridade de grupo comum da sustentabilidade.

  \item [Sustentabilidade tem mútiplas dimensões]
    Nós temos que incluir estas dimensões em nossa análise se queremos entender
  ...
  \item [Sustentabilidade é um preocupação independente de propósito do sistema]
...
Então e agora? Como podemos começar?

Cada um dos seguintes interessados pode fazer algo agora mesmo para iniciar.
