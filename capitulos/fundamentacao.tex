...
Os {\it Dagstuhl Perspectives Workshops} eventos organizados por e para um
pequeno grupo de pesquisadores sêniores de renome internacional, refletem o
estado da ciência da computação olhando pesquisas recentes olhando para o
futuro, com uma discussão intensiva com foco estratégico, explora tópicos novos
e emergentes na ciência da computação e produz manifestos que capturam
tendências e desenvolvimentos relacionados à estes tópicos. 

Tentando reflexão identificar pontos fortes e fracos, novos objetivos, campos e
aplicações da ciência da computação com objetivo de traçar novos
desenvolvimentos promissores e identificar problemas relevantes e buscar
sinergia entre os diferentes campos.

Iniciado em 2011 a série Dagstuhl Manifestos publica manifestos com os resultados
dos Dagstuhl Perspectives Workshops. 

\begin{itemize}
  \item 2017: Engineering Academic Software (Dagstuhl Perspectives Workshop 16252)
  \item 2015: Connecting Performance Analysis and Visualization (Dagstuhl Perspectives Workshop 14022)
  \item 2015: Privacy and Security in an Age of Surveillance (Dagstuhl Perspectives Workshop 14401)
  \item 2014: Massive Open Online Courses: Current State and Perspectives (Dagstuhl Perspectives Workshop 14112)
  \item 2014: Co-Design of Systems and Applications for Exascale (Dagstuhl Perspectives Workshop 12212)
  \item 2013: Machine Learning Methods for Computer Security (Dagstuhl Perspectives Workshop 12371)
  \item 2013: ICT for Bridging Biology and Medicine (Dagstuhl Perspectives Workshop 13342)
  \item 2012: Social, Supply-Chain, Administrative, Business, Commerce, Political networks: a multi-discipline perspective (Dagstuhl Perspectives Workshop 12182)
  \item 2012: Computation and Palaeography: Potentials and Limits (Dagstuhl Perspectives Workshop 12382)
  \item 2011: Social, Supply-Chain, Administrative, Business, Commerce, Political networks: a multi-discipline perspective (Dagstuhl Perspectives Workshop 12182)
  \item 2011: Computation and Palaeography: Potentials and Limits (Dagstuhl Perspectives Workshop 12382)
  \item 2011: Improving The Future of Research Communications and e-Scholarship (Dagstuhl Perspectives Workshop 11331)
\end{itemize}
...
{\it Dagstuhl Perspectives Workshop on ``Engineering Academic Software''}
\cite{allen2017engineering} voltado a examinar
as fortalezas, fraquezas, riscos e oportunidades da engenharia de software
acadêmica, contribuição chave um
roteiro para o futuro da engenharia de software profissional e acadêmica, com
foco em instrumentos para pesquisas em software. O manifesto é expresso em
termos de ações ``promessas'' destinados a usuários e desenvolvedores de
softwares acadêmicos, com passos concretos para melhorar o ambiente em que os
...
Esta consciência leva à necessidade de redefinir a narrativa sobre a
...
Como resultado, mesmo diante do reconhecimento crescente da importancia da sustentabilidade,
