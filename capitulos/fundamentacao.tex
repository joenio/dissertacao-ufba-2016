...
% a partir de pesquisas recentes olhando para o futuro
%
...
%\begin{itemize}
%  \item Improving The Future of Research Communications and e-Scholarship
%  \item Computation and Palaeography: Potentials and Limits
%  \item Social, Supply-Chain, Administrative, Business, Commerce, Political networks: a multi-discipline perspective
%  \item ICT for Bridging Biology and Medicine
%  \item Machine Learning Methods for Computer Security
%  \item Co-Design of Systems and Applications for Exascale
%  \item Massive Open Online Courses: Current State and Perspectives
%  \item Privacy and Security in an Age of Surveillance
%  \item Connecting Performance Analysis and Visualization
%  \item Engineering Academic Software
%\end{itemize}
%% 
