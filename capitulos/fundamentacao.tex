...
%% Caminhos
%% * Ciência aberta
%% * Pesquisas reproduzı́veis
%% * Ciber-infraestrutura
%% Análise estática de código fonte . . . . . . . . . .
%% 2.3.1 Usos da análise estática de código fonte . .
%% 2.3.2 Anatomia da análise de código fonte . . .
%% 2.3.3 Formatos de representação intermediária .
%% 2.3.4 Técnicas de análise . . . . . . . . . . . . .
...
%Neste contexto, é fundamental que a contribuição intelectual do software seja
%reconhecida e apoiada ativamente. À medida que o software está se tornando
%parte integrante de nossos processos, das ferramentas que usamos e da produção
%que produzimos, essa perspectiva fornece um ponto de partida para uma discussão
%tanto atempada quanto urgente \cite{allen2017engineering}.
...
O desenvolvimento de software científico é fundamentalmente diferente do
...
%Esperamos que esta questão especial forneça algum sabor dessa variedade.
