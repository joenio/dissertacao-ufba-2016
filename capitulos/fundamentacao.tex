...
%
% (historiador da ciencia, ciencia comum, parte de open science, referencia filosofica central para meu trabalho)
% https://pt.wikipedia.org/wiki/Antonio_Lafuente
% https://pimentalab.milharal.org/2015/07/16/ciencia-comum-e-laboratorios-cidadaos-com-antonio-lafuente/
...
%
%
%Isto põe os softwares numa posição de destaque no debate sobre
...
\subsection{Software acadêmico de origem científica}
...
%
%Isto torna os softwares acadêmicos tão importantes para a ciência quanto
%qualquer outro aparato científico, como por exemplo
%
%Isto tem motivado a comunidade a refletir sobre
%a importância dos softwares para a ciência chegando a conclusões que
%os softwares acadêmicos são tão importantes para a ciência quanto são os
%telescópios ou tubos de ensaio \cite{wilson2014best}.  
%
...
%%% mais da metade dos cientistas de todas as áreas usam softwares acadêmicos em
%%% suas pesquisas, pesquisadores trabalhando exclusivamente com problemas
%%% computacionais, em laboratórios tradicionais ou em campo, todos
%%% usam softwares de alguma forma, seja para coleta ou análise de dados, seja em
%%% outras atividades dentro do processo científico.
%%% 
%%% Boa parte destes softwares são desenvolvidos na própria academia, cientistas
%%% gastam mais tempo hoje usando e desenvolvendo softwares do que gastavam no
%%% passado, apesar disso muitas pesquisas nem ao menos mencionam a utilização de
%%% softwares acadêmicos em suas publicações, outras pesquisas, ao publicar novos
%%% softwares, não testam ou documentam o seu uso, e raramente publicam seus
%%% códigos.
%%% 
%%% Como resultado, dados são perdidos, análises levam mais tempo que o necessário
%%% e os pesquisadores não conseguem a eficiência ao trabalhar com softwares
%%% acadêmicos, isto, além de ocasionar erros em conclusões centrais da literatura
%%% leva ao problema conhecido como ``dysfunctional chaotic churn'',
%%% ou
...
%%% 
%%% Isto, além de contradizer as boas práticas de qualquer projeto experimental,
%%% desacelera o progresso da ciência uma vez que oportunidades de colaboração são
%%% perdidas e torna praticamente impossível utilizar o método mais comum e
%%% cientificamente produtivo de produzir conhecimento novo a partir de pesquisas
%%% anteriores através da replicação, ferindo um dos princípios da ciência de que
%%% novas descobertas sejam reproduzidas antes de serem consideradas parte da base
%%% de conhecimento.
%%% 
%%% 
%%% Como o problema ``dysfunctional chaotic churn'' se apresenta nas
