...
Esta definição de software acadêmico tem relação com definições semelhantes:

Software de pesquisa ({\it research software}) \cite{hettrick_2014_14809} é
todo software pretende divulgar numa publicação. Software de pesquisa pode ser
qualquer coisa entre escritas por você mesmo, até mesmo um software
...
- não são considerados softwares de pesquisa.
...
Num estudo feito entre 2014 e 2015 com dados coletados de 1142 atronomos de
todos os níveis de carreira mostrou que todos usam softwares em suas pesquisa,
e a grande maioria 90\% escrevem pelo menos parte do seu próprio software,
estes números independem do estágio na carreira, área de pesquisa ou região.
\cite{momcheva2015software}.

56\% dos pesquisadores, entre todas as disciplinas, escrevem parte do seus
softwares \cite{hettrick_2014_14809}.

Software is increasingly crucial to scholarship, yet the
visibility and usefulness of software in the scientific
record are in question. Just as with data, the visibility of
software in publications is related to incentives to share
software in reusable ways, and so promote efficient
science. In this article, we examine software in publica-
tions through content analysis of a random sample of 90
biology articles. We develop a coding scheme to identify
...
practices: Only between 31% and 43% of mentions
involve formal citations; informal mentions are very
common, even in high impact factor journals and across
different kinds of software. Software is frequently inac-
cessible (15%–29% of packages in any form; between
90% and 98% of specific versions; only between 24%–
40% provide source code). Cites to publications are par-
ticularly poor at providing version information, whereas
informal mentions are particularly poor at providing
crediting information. We provide recommendations to
improve the practice of software citation, highlighting
recent nascent efforts. Software plays an increasingly
great role in scientific practice; it deserves a clear and
useful place in scholarly communication.
From the 90 articles total, we identified 59 that men-
tioned software and 31 that did not (65% of articles men-
tioned software)
...
We argue that the astronomical community’s increasing dependence on software and analysis
requires that it come to see software as an integral part of its scientific practice.

Elevating
the status of software does not mean hiring a new army of programmers, but recognizing
the achievements of the scientists who create the tools we use, and removing barriers to the
production, completion, and sharing of astronomical software. We advocate greater openness
in software release and incentives for this, borrowing from the techniques that have made
open source software successful.
Inevitably some software will be resoundingly useful on first release, some will go through
generations of improvement, some will be used in its original version without updates or
maintenance, and some will be released and never used. This is a perfectly fine outcome. A
software ecosystem will let the community decide what is most useful and develop collabo-
rations through an evolutionary process, rather than acting as gatekeepers or keeping code
proprietary for transitory advantages. The process of testing, comparison, challenge, and
incremental progress is at the heart of free scientific inquiry, and it can free our code as well
...
include papers in Science [7,8], PNAS [9], the Journal of Molecular
Biology [10], Ecology Letters [11,12], the Journal of Mammalogy [13],
Journal of the American College of Cardiology [14], Hypertension [15], and
The American Economic Review [16].
...
cascading impact caused several prominent retractions when an
another group’s code was not discovered until after
...
and providing a mechanism for research software developers to receive credit. While designed
...
more than 40 additional articles currently under review. JOSS is a sponsored project of the
nonprofit organization NumFOCUS and is an affiliate of the Open Source Initiative (OSI)
\cite{smith2017journal}.
