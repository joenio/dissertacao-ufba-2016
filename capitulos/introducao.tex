...
\newcommand{\QuestaoDois}{
  As características de publicização influenciam o reconhecimento ao software
  acadêmico de análise estática publicado nas conferências de Engenharia de
  Software ASE e SCAM?
}
\newcommand{\QuestaoTres}{
  O estágio de evolução no ciclo de vida influencia o reconhecimento ao
  software acadêmico de análise estática publicado nas conferências de
...
\newcommand{\QuestaoQuatro}{
  Qual o tamanho médio do software acadêmico de análise estática publicado nas
...
\newcommand{\QuestaoSeis}{
  As pesquisas mencionando software acadêmico de análise estática publicado nas
  conferências de Engenharia de Software ASE e SCAM podem ser replicadas ou
  reproduzidas?
}
