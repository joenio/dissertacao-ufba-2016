...
O capítulo \ref{estudo2} descreve um estudo sobre menções encontradas nas bases
ACM e IEEE ao software acadêmico de análise estática.

O capítulo \ref{estudo3} apresenta um estudo sobre o ciclo de vida do software
acadêmico de análise estática.
