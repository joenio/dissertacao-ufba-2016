...
\begin{enumerate}
  \item [{\bf Q1 (opção a):}] {\em O custo de mudança e a complexidade
  ...
  \item [{\bf Q1 (opção b):}] {\em Uma maior complexidade estrutural das
...
\begin{enumerate}
  ...
  \item[{\bf H5:}] {\em Os valores de métricas de código-fonte calculados para
    as ferramentas de análise estática de código-fonte estão dentro dos
    thresholds para métricas de código-fonte encontrados na literatura.}
\end{enumerate}
