...
de fontes documentais variadas. Figura \ref{estudo1-etapas}.
...
Todos os artigos publicados nas conferências são incluídos, deve-se definir uma
data final limite como critério de inclusão e exclusão, sendo que a data
...
que a conferência mude de nome ao longo do tempo, neste caso adotamos como
...
Todas as informações foram gerenciadas manualmente com o auxílio de uma
planilha eletrônica da suíte de escritório LibreOffice, com as colunas: Evento,
Busca, Fitro, Selecao, Software e Anotações. Cada linha representa um artigo.
Esta planilha e seu formato é melhor apresentado em detalhes no Apêndice
...
representando cada subconjunto um dos critérios de inclusão desta
fase.
