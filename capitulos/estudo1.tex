...
%de análise estática divulgados nas conferências de Engenharia de Software ASE e
%SCAM até o ano de 2015.}
{}
\label{estudo1}
...
%
Neste contexto, a \textit{disponibilidade} do software, isto é,
a capacidade do software acadêmico ser obtido
...
Em tais condições, diz-se que o software acadêmico sofre de {\it
...
\cite{wilson2017good}, 
incluindo a disponibilidade do software acadêmico. %REF?.
...
nas conferências ASE e SCAM permanecem disponíveis e 
quais são as informações que podem ser obtidas.
O objetivo da pesquisa está definido segundo a estrutura GQM CITE???
...
em relação à sua disponibilidade.
...
JUSTIFICAR ESCOLHA DESSAS CONFs?
