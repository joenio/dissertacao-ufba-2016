...
A revisão de literatura encontrou \PapersExtractionCount \ artigos com publicação de projeto de
software acadêmico de análise estática entre os \PapersCount \ artigos publicados nas
...
\begin{figure}[h]
  \center
  \includegraphics[scale=0.4]{documents/images/revisao-literatura.png}
...
planejamento. Ao final da inspeção manual, selecionamos \PapersExtractionCount \ artigos com publicação de
...
Dentre os \PapersExtractionCount \ artigos selecionados, dois artigos faziam referência a um mesmo software e,
...
ASE e SCAM, selecionamos \PapersExtractionCount \ artigos com publicação de software acadêmico de
...
% TODO atualizar os numeros do paragrafo abaixo
...
oficial online no endereço de URL informado pelos seus autores, \UrlAvailableCount \ projetos
...
SCAM: Dos \SoftwareSCAMCount \ projetos de software estudados neste trabalho, \SoftwareUrlNotAvailableSCAMCount \ não têm presença
oficial online no endereço de URL informado pelos seus autores, \SoftwareUrlAvailableSCAMCount \ projetos
estão presentes através da URL informada de alguma forma, significando que as
URL informada pelos autores estão ativas e online.
...
SCAM: Entre os \SoftwareSCAMCount \ projetos selecionados, \SoftwareDownloadNotAvailableSCAMCount \ não estão disponíveis para download, ou
seja, apesar dos autores informarem no estudo uma URL, indicarem que o software
está disponível nesta URL para download, a URL não mais está disponível e o
software não pode ser encontrado. Isso significa que ??\% dos projetos de software
acadêmico de análise estática publicados na conferência de Engenharia de
Software SCAM não estão disponíveis ou estão disponíveis em outra URL.

Os demais \DownloadAvailableCount \ projetos, que equivalem a 60\% do conjunto total, estão
...
SCAM: Os demais \SoftwareDownloadAvailableSCAMCount \ projetos, que equivalem a ??\% do conjunto total, estão
disponíveis para download e é possível obter uma cópia destes projetos na URL
indicada pelos seus autores. Um resumo deste total por ano é apresentado na
Tabela \ref{available-table}.
...
Do conjunto de \DownloadAvailableCount \ projetos de software disponíveis para download,
apenas \SoftwareSourceCodeNotAvailableCount \ (era 2) não
...
SCAM: Do conjunto de \SoftwareDownloadAvailableSCAMCount \ projetos de software disponíveis para download,
apenas \SoftwareSourceCodeNotAvailableSCAMCount \ não
disponibilizam o código-fonte.

\input{documents/source-code-table.tex}

\subsection{Q4 - \EstudoUmQuestaoQuatro} % licença

Dentre os \SourceCodeAvailableCount \ (era 34) projetos que disponibilizaram o código-fonte,
\LicenseUndefinedCount \ (era 13) não informaram
licença alguma e \FreeSoftwareCount \ (era 21) informaram licenças de software livre.
A Tabela \ref{license-table} resume as licenças utilizadas e o
número de projetos em cada uma.

SCAM: Dentre os \SourceCodeAvailableCount \ (era 34) projetos que disponibilizaram o código-fonte,
\LicenseUndefinedCount \ (era 13) não informaram
licença alguma e \FreeSoftwareCount \ (era 21) informaram licenças de software livre.
A Tabela \ref{license-table} resume as licenças utilizadas e o
número de projetos em cada uma.
...
sem qualquer restrição prévia pelos seus autores, mas os \LicenseUndefinedCount \ projetos sem
...
Considerando o total de \SoftwareCount \ projetos selecionados neste estudo, apenas 35\%
(\FreeSoftwareCount \ projetos) podem ser adaptados;
os demais com código-fonte disponível, 21\% (\LicenseUndefinedCount \ projetos) podem ser
...
Nos \UrlAvailableCount \ projetos com presença online através da URL informada nos artigos, 9 não
...
Os outros \DownloadAvailableCount \ projetos estão disponíveis para download, sendo que
a maior parte, \SourceCodeAvailableCount \ (era 34) projetos, disponibiliza o código-fonte, e apenas 2
estão disponíveis em formato binário.
Dentre os 34 projetos com código-fonte disponível, \LicenseUndefinedCount \ (era 13) não informam qualquer
licença de uso.
