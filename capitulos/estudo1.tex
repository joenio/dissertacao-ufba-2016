...
No entando, muitos projetos de software acadêmico possuem ciclos de vida curtos,
tornando-se indisponíveis tão logo acaba o financiamento inicial \cite{howison2015understanding}.
Parte deste problema tem sido atribuído a falta de treinamento em boas práticas
...
são nosso principal objeto de estudo, uma vez que são.
...
fonte publicados nas conferências ASE e SCAM, ao todo foram inspecionados 1873
