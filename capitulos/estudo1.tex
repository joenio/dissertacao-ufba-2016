\xchapter{Disponibilidade de código de projetos de software acadêmico de análise estática}
{Este capítulo apresenta um estudo sobre disponibilidade para download (binário ou código-fonte)
...
%A partir de uma revisão de literatura em conferências da área de Engenharia de Software, 
...
problema de ``dysfunctional chaotic churn'' percebido por \citeonline{howison2015understanding}.
...
que forma o projeto está disponível, binários ou código fonte, quais
