...
O objeto de estudo são artigos publicados nas conferências de Engenharia de Software ASE e SCAM.

\item{\bf Propósito.} 
O propósito é encontrar software acadêmico publicado como contribuição.

\item{\bf Perspectiva.} 
A perspectiva considerada é a de cientistas usuários finais interessados em obter e utilizar software acadêmico.

\item{\bf Foco de qualidade.} 
O principal aspecto de qualidade estudado é a identificação de URL para obtenção do software acadêmico.
...
no contexto de \textit{projetos de software análise estática}. % context

\subsection{Questões de Pesquisa}

Neste estudo as seguintes questões de pesquisa, a respeito dos artigos
publicados nas conferências ASE e SCAM, serão investigadas:

\newcommand{\EstudoUmQuestaoUm}{É possível obter uma cópia dos projetos através da URL identificada nos artigos?}
\newcommand{\EstudoUmQuestaoDois}{Os projetos aceitam explicitamente contribuição de código fonte?}
...
\begin{enumerate}
  \item número de artigos com publicação de software acadêmico com identificação de URL
  \item número de projetos de software acadêmico de análise estática com URL acessível
\end{enumerate}
