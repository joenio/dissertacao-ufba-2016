...
Sabendo disso, e atentando para o fato de que grande parte do desenvolvimento de
...
software desenvolvidos nas pesquisas de Engenharia de Software apresentam sintomas
de ``dysfunctional chaotic churn'' conforme percebido por \citeonline{howison2015understanding}.
%como ``dysfunctional chaotic churn''.
...
dados, possivelmente com objetivo de ser utilizado por outros
pesquisadores e, em algumas ocasiões, sendo o próprio software uma contribuição primária
...
URL informada de alguma forma, significando que as URL informada pelos autores
