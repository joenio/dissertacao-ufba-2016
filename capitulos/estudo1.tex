...
%trecho abaixo foi movido para introducao: estrategia de pesquisa
...
%Apesar disso, o estudo tem como objetivo
%caracterizar os projetos e não as conferências em si, de forma que esta ameaça
...
Este estudo selecionou 60 projetos de software de análise estática de
...
%Ao todo foram
%inspecionados 1873
%artigos, incluindo todas as edições das duas conferências até o ano de 2015.

%Os projetos selecionados tiveram como critério a identificação
%de nome e URL para download.

%As únicas informações
%disponíveis destes 15 projetos são aquelas encontradas nos artigos onde foram
%publicados.

Entre os projetos selecionados, 15 não têm qualquer presença oficial online,
...
%E 19 projetos utilizam licenças de software livre e dão
%prévia autorização para receber melhorias em código-fonte.
%e, dessa forma, impedem que melhorias e correções
