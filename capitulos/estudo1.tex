...
No entando, muitos projetos de software acadêmico possui ciclos de vida curtos,
tornando-se indisponíveis ao longo do tempo.
...
Software, especialmente em relação aos sintomas ``dysfunctional chaotic churn'' \cite{howison2015understanding}.
%conforme percebido por 
...
Todos os projetos foram identificados pelos seus autores com o nome do projeto e URL para download.
