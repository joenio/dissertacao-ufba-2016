...
% Recomendações: https://openresearchsoftware.metajnl.com/articles/10.5334/jors.bt/
% Desenvolva e Documente as Melhores Práticas
% Reviewed Software Repository: Participants recommended that ESIP members might create
% a curated and reviewed software repository that includes an ESIP “stamp of approval” for reviewed software. 

% Outros estudos (futuro):
% Aspectos de ES? Processo: Modelo Staged? Testes? Resolução de issues?
% Produto: Complexidade estrutural? 
% User: Documentação? Usabilidade? **usabilidade** me parece o próximo passo de investigação

% estudo para o futuro, investigar proposicao P11 da teoria de terceiro
% estudo relacionado a esta proposição \cite{Maccormack2006}
% estudo mostrou evidencias de impacto na modularidade
%  Exploring the duality between product and organizational architectures: A test of
