...
\newcommand{\EstudoDoisQuestaoUm}{Quantos projetos de software acadêmico de
...
análise estática publicados nas conferências ASE e SCAM são utilizados e
avaliados em estudos encontrados nas bases ACM e IEEE?}
...
advindas de estudos encontrados nas bases ACM e IEEE?}

\newcommand{\EstudoDoisQuestaoQuatro}{Os projetos de software acadêmico de
análise estática publicados nas conferências ASE e SCAM recebem contribuições
relevantes (mudar esta pergunta) advindas de estudos encontrados nas bases ACM
e IEEE?}

\newcommand{\EstudoDoisQuestaoCinco}{Os projetos de software acadêmico de
análise estática publicados nas conferências ASE e SCAM tiveram aumento no
número de cientistas mencionando os projetos nas bases ACM e IEEE?}
...
\begin{description}
  ...
  \item [Q5:] \EstudoDoisQuestaoCinco
\end{description}
...
\input{result-documents/visibility-table.tex}

\subsection{Autoria das menções aos projetos de software de análise estática}

... a Tabela \ref{authorship-table} ...

\input{result-documents/authorship-table.tex}
...
\subsection{Q5 - \EstudoDoisQuestaoCinco}
