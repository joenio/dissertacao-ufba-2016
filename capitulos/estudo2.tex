...
\begin{description}
  \item{\bf Objeto de estudo.}
    O objeto de estudo são os 60 projetos de software de análise estática
...
contexto sem relação alguma com o projeto em sí.
...
%A Tabela \ref{references-table} apresenta o total de resultados para cada
%um dos projetos pesquisados

%, incluin os artigos do arquivo \texttt{paper.bib}.
...
Manutenibilidade, ou seja, o esforço necessário para
