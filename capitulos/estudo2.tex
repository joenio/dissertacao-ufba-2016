...
Considerando apenas as menções relacionados aos projetos da conferência SCAM:
\CiteSCAMCount \ são do tipo Cita,
\UseSCAMCount \ são menções Usa e
\ContributeSCAMCount \ são menções Contribui

Considerando apenas as menções relacionadas aos projetos da conferência ASE:
\CiteASECount \ são do tipo Cita,
\UseASECount \ são menções Usa e
\ContributeASECount \ são menções Contribui.
