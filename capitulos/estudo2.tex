...
Qualquer um que trabalha com software acadêmico saberá que o nível de
reconhecimento e retribuição para o software e para quem revisa ou desenvolve
não é proporcional a sua importância, o sistema de recompensa é quase que
exclusivamente baseado em publicação científica, e infelizmente, compartilhar
software ainda provê pouco mérito, mesmo que seja realmente útil para outros
