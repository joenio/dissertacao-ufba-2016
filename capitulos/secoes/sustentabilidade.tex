...
Uma outra iniciativa, liderada pela pela {\it Free Software Foundation Europe}
(FSFE), chamada {\it Public Money, Public Code}
\cite{europe_fsfe_public_nodate}, é uma campanha que propõe uma legislação
obrigando que todo software financiado com dinheiro dos contribuintes,
desenvolvido para o setor público, seja publicado com uma licença de Software
Livre.
...
%apesar do apelo da comunidade científica para que o
%software acadêmico seja tratado como cidadão de primeira classe, 
